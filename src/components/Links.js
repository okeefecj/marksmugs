        ...
        <div className="Links">
            <h2>Our Retailers</h2> 
                <body>
                    ...
                    <img src={Starbucks} width="150" height="150"/>
                    </a>
                    <a href="https://www.target.com/">
                        <img src={Target} width="150" height="150"/>
                    </a>
                    <a href="https://circuitcity.com/"> 
                        <img src={CircuitCity} width="150" height="150"/>
                    </a>
                    <a href="https://www.basspro.com/shop/en#">
                        <img src={BassProShops} width="150" height="150"/>
                    </a>
                </body>
            </div>
    );
